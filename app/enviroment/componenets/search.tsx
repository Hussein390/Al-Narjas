...
import { getEnvironment, getItems } from "../../../backend/enviroment";
import { Input } from "@/components/ui/input";
import { DataPhones, ItemProps, } from "../../components/dataProvider";
...
export default function Search() {
  ...
  async function getPhones() {
    ...
    const items = await getItems(EnvId)
